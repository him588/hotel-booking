...
function Login() {
  return (
    <div className="flex items-center justify-between h-[120vh] w-full bg-[#f9f9ff] px-[30px] py-[20px] font-[Raleway] max-[400px]:flex-col max-[400px]:px-[15px] ">
      ...
      <div className="w-[50%]  backdrop-filter backdrop-blur-sm bg-opacity-70 bg-clip-padding rounded-md bg-[#f9f9ff] relative z-50 p-[30px] max-[400px]:mt-[160px] max-[400px]:w-[95%] max-[400px]:p-[15px] ">
        <Form></Form>
      </div>
